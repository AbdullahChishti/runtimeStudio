export const company = {
  ...
  about: {
    ...
    team: {
      note: "We're a small team of senior engineers, QA architects, and AI specialists. Placeholder profiles below — update with your team as you grow.",
      members: [
        {
          name: "Lead Engineer",
